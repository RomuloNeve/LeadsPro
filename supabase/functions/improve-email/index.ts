...
- Retorne APENAS o corpo do email melhorado, sem assunto, sem explicações extras.`,
    ...
    if (!response.ok) {
      ...
      const friendly = lowQuota
        ? "A IA para melhorar emails está temporariamente indisponível (cota esgotada). Tente novamente mais tarde ou contate o suporte."
        : "Não consegui melhorar o email agora. Tente novamente em instantes.";
      return new Response(
