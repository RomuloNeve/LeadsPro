    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <Section className="border-t border-border/40" ariaLabel="Veja a plataforma por dentro">
        <SectionHeader
          ...
          title={<>Conheça cada ferramenta <span className="gradient-text">em detalhes</span></>}
          subtitle="Não é promessa. É o que você vai usar todos os dias para prospectar, engajar e converter."
        />
      ...
      <Section id="how" className="border-t border-border/40" ariaLabel="Como funciona">
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
          {[
            ...
            { n: "03", title: "Organize no CRM", desc: "Seus leads ficam organizados com filtros, listas personalizadas e categorias inteligentes.", icon: Database },
          ].map((s, i) => (
            <motion.div
              key={s.n}
        ...
        <div className="hidden md:flex justify-center my-8" aria-hidden="true">
          <div className="w-px h-12 bg-gradient-to-b from-primary/20 to-primary/5" />
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
          {[
            ...
            { n: "06", title: "Email Marketing", desc: "Envie emails em massa com templates prontos, IA para copywriting e seu próprio domínio.", icon: Mail },
          ].map((s, i) => (
            <motion.div
              key={s.n}
              className="text-center relative"
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
          {[
            ...
            { n: "09", title: "Feche negócios", desc: "Acompanhe tudo no painel com estatísticas, métricas e ranking de categorias.", icon: TrendingUp },
          ].map((s, i) => (
            <motion.div
              key={s.n}
              className="text-center relative"
      ...
      {/* ═══ WHATSAPP INTEGRADO ═══ */}
      <Section className="border-t border-border/40 relative overflow-hidden" ariaLabel="WhatsApp integrado">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,hsl(var(--primary)/0.06),transparent_70%)] pointer-events-none" aria-hidden="true" />
        <div className="relative">
          <SectionHeader
            badge="WhatsApp 360°"
            title={<>Seu WhatsApp <span className="gradient-text">dentro da plataforma</span></>}
            ...
            {[
              {
                ...
                desc: "Escaneie o QR Code uma vez e sua instância fica ativa 24h. Use seu próprio número — sem chip extra, sem API paga.",
                highlight: "Seu número real",
              },
              {
                icon: <Inbox className="h-6 w-6" />,
                title: "Caixa de entrada completa",
                desc: "Veja todas as conversas, responda com texto, áudio, imagens e reações. É como o WhatsApp Web, mas integrado ao seu CRM.",
                highlight: "Conversas em tempo real",
              },
              {
                icon: <Send className="h-6 w-6" />,
                title: "Disparo em massa inteligente",
                desc: "Envie mensagens personalizadas para centenas de leads de uma vez. Com imagem, variáveis e intervalo automático entre envios.",
                highlight: "Centenas de mensagens",
              },
            ].map((card, i) => (
              <motion.div
                key={card.title}
              ...
              >
                ...
                <Badge variant="outline" className="mb-3 text-[10px] border-primary/20 text-primary">
                  {card.highlight}
                </Badge>
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto mb-8 sm:mb-10">
            {[
              {
                icon: <Repeat className="h-5 w-5" />,
                title: "Follow-up automático",
                desc: "Configure sequências automáticas (dia 1, 3, 5, 7) e nunca mais perca um lead por esquecimento.",
              },
              {
                icon: <UsersRound className="h-5 w-5" />,
                title: "Gestão de grupos",
                desc: "Crie grupos, veja participantes e gerencie tudo sem sair da plataforma.",
              },
              {
                icon: <MessageCircle className="h-5 w-5" />,
                title: "Mídia rica",
                desc: "Envie e receba áudio, imagens, vídeos, documentos e vCards — tudo renderizado na interface.",
              },
              {
                icon: <BarChart3 className="h-5 w-5" />,
                title: "Métricas de campanha",
                desc: "Acompanhe quantos foram enviados, entregues e respondidos em tempo real.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
                className="flex gap-4 items-start p-4 rounded-xl border border-border/30 bg-card/30"
          ...
          <motion.div
            className="max-w-2xl mx-auto text-center p-5 sm:p-6 rounded-2xl border border-primary/20 bg-primary/[0.03]"
          ...
          >
            <p className="text-base text-muted-foreground mb-4">
              <span className="text-foreground font-semibold">Outras plataformas cobram R$ 200+/mês</span> só pela automação de WhatsApp.
              No LeadsPro, está <span className="text-primary font-bold">incluso no seu plano</span> — sem custo extra.
            </p>
            <a href="#pricing">
              <Button size="lg" className="gradient-bg text-primary-foreground font-bold px-10 text-base rounded-full shadow-lg">
                Quero usar agora <ArrowRight className="h-4 w-4 ml-1" />
              </Button>
            </a>
          </motion.div>
        </div>
