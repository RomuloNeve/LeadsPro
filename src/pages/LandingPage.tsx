...
const LandingPage = () => {
  ...
  const faqs = [
    ...
    { q: "Como enviar mensagem em massa no WhatsApp sem ser banido?", a: "O LeadsPro usa 7 camadas de proteção: (1) variação automática de texto por IA, (2) intervalos randômicos de 60-180 segundos entre cada mensagem com pausas extras de digitação, (3) bloqueio automático fora do horário 8h-21h, (4) limite diário de 150 mensagens, (5) micro-lotes com pausas longas, (6) lista negra automática de números inválidos, e (7) seu número via QR Code. Quanto mais camadas, mais protegido seu número fica." },
