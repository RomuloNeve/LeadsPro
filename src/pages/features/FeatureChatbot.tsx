        ...
        <motion.div className="max-w-5xl mx-auto" initial="hidden" animate="visible">
          ...
          <motion.div variants={fadeUp} custom={2.5} className="mb-12">
            <div className="rounded-2xl border border-border/60 overflow-hidden shadow-xl">
              <img src={featChatbot} alt="Interface do Chatbot IA com configuração e leads ativos" className="w-full" />
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUp} custom={15} className="mb-16">
            ...
            <div className="rounded-2xl border border-border/60 overflow-hidden shadow-xl">
              <img src={featAtendimentoHumano} alt="Painel de Atendimento Humano com solicitações de leads" className="w-full" />
            </div>
          </motion.div>
